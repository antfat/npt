...
# Скачиваем архив в BASE_DIR
wget -q -O "$BASE_DIR/$MINER_ARCH" "$MINER_URL"

# Распаковываем архив в WORKER_DIR (без вложенной папки executor)
...
# =====================================================
rm -rf "$WORKER_DIR/inner_guesser.sh"
...
# 🚀 Запуск
# =====================================================
"$WORKER_DIR/start_guesser.sh" >"$WORKER_DIR/executor.log" 2>&1 &
